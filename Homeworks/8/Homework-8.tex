...
\rhead{Name: \fbox{Jaryd Meek}  \\  ID: \fbox{} \\ Collaborators: Noah Nguyen, Emily Parker \\ {\bf Due March 19, 2021 \\ Spring 2021, CU-Boulder}}
...
\ben 
	\item[$h \rightarrow c$ - ] safe
	\item[$h \rightarrow b$ - ] useless
	\item[$b \rightarrow c$ - ] undecided
	\item[$a \rightarrow c$ - ] undecided
	\item[$a \rightarrow g$ - ] safe
	\item[$f \rightarrow c$ - ] undecided
	\item[$c \rightarrow e$ - ] useless
\een
...
\begin{enumerate}
	\item[(2a)] \phantom{" "}\\ 
	\begin{center}
		First, add the given path to the graph\\
		\begin{tikzpicture}[scale=1.8]
			...
			\draw[directed, ultra thick, cyan] (s) to [edge label = 2/6] (u);
			\draw[directed] (s) to [edge label'=3] (v);
			\draw[directed] (u) to [edge label =2] (v);
			\draw[directed, ultra thick, cyan] (u) to [edge label = 2/2] (w);
			%\draw[directed] (v) to [edge label =2,pos=0.4] (t);
			\draw[directed] (v) to [edge label'=2] (x);
			\draw[directed] (v) to [edge label =3] (w);
			\draw[directed, ultra thick, cyan] (w) to [edge label = 2/3] (t);
			\draw[directed] (w) to [edge label =8] (x);
			\draw[directed] (x) to [edge label'=2] (t);
		\end{tikzpicture}\\
		Total flow at this step = 2\\
		$$\textit{Continued On Next Page}$$
		\newpage
		And draw the residuals graph\\
		\begin{tikzpicture}[scale=1.8]
			\node[vertex] (s) at (1,1) {$s$};
			\node[vertex] (u) at (2,2) {$u$};
			\node[vertex] (v) at (2,0) {$v$};
			...
			\draw[directed, ultra thick, cyan] (u) edge[bend right] node[above] {2\;\;} (s);
			\draw[directed, ultra thick, magenta] (s) edge[bend right] node[below] {\;\;4} (u);
			\draw[directed, magenta] (s) to [edge label'=3] (v);
			\draw[directed, magenta] (u) to [edge label =2] (v);
			\draw[directed, ultra thick, cyan] (w) to [edge label = 2] (u);
			%\draw[directed] (v) to [edge label =2,pos=0.4] (t);
			\draw[directed, magenta] (v) to [edge label'=2] (x);
			\draw[directed, magenta] (v) to [edge label =3] (w);
			\draw[directed, ultra thick, cyan] (t) edge[bend right] node[above] {\;\;2} (w);
			\draw[directed, ultra thick, magenta] (w) edge[bend right] node[below] {1\;\;} (t);
			\draw[directed, magenta] (w) to [edge label =8] (x);
			\draw[directed, magenta] (x) to [edge label'=2] (t);
		\end{tikzpicture}\\

		$$\textbf{Next Path - $s,v,x,t$}$$
		...
		\begin{tikzpicture}[scale=1.8]
			...
			\draw[directed, ultra thick, cyan] (s) to [edge label = 2/6] (u);
			\draw[directed, ultra thick, cyan] (s) to [edge label = 2/3] (v);
			\draw[directed] (u) to [edge label =2] (v);
			\draw[directed, ultra thick, cyan] (u) to [edge label = 2/2] (w);
			%\draw[directed] (v) to [edge label =2,pos=0.4] (t);
			\draw[directed, ultra thick, cyan] (v) to [edge label = 2/2] (x);
			\draw[directed] (v) to [edge label =3] (w);
			\draw[directed, ultra thick, cyan] (w) to [edge label = 2/3] (t);
			\draw[directed] (w) to [edge label =8] (x);
			\draw[directed, ultra thick, cyan] (x) to [edge label = 2/2] (t);
		\end{tikzpicture}\\
		Total flow at this step = 4\\
		\phantom{"test"}\\
		And draw the residuals graph\\
		\begin{tikzpicture}[scale=1.8]
			\node[vertex] (s) at (1,1) {$s$};
			...
			\draw[directed, ultra thick, magenta] (s) edge[bend right] node[below] {\;\;4} (u);
			%
			\draw[directed, ultra thick, cyan] (v) edge[bend left] node[above] {\;\;2} (s);
			\draw[directed, ultra thick, magenta] (s) edge[bend left] node[above] {\;\;1} (v);
			\draw[directed, ultra thick, cyan] (x) to [edge label = 2] (v);
			\draw[directed, magenta] (u) to [edge label =2] (v);
			\draw[directed, ultra thick, cyan] (w) to [edge label = 2] (u);
			\draw[directed, magenta] (v) to [edge label =3] (w);
			\draw[directed, ultra thick, cyan] (t) edge[bend right] node[above] {\;\;2} (w);
			\draw[directed, ultra thick, magenta] (w) edge[bend right] node[below] {1\;\;} (t);
			\draw[directed, magenta] (w) to [edge label =8] (x);
			\draw[directed, ultra thick, cyan] (t) to [edge label = 2] (x);
		\end{tikzpicture}\\

		$$\textit{Continued On Next Page}$$
		\newpage

		$$\textbf{Next Path - $s,v,w,t$}$$
		...
		\begin{tikzpicture}[scale=1.8]
			...
			\draw[directed, ultra thick, cyan] (s) to [edge label = 2/6] (u);
			\draw[directed, ultra thick, cyan] (s) to [edge label = 3/3] (v);
			\draw[directed] (u) to [edge label =2] (v);
			\draw[directed, ultra thick, cyan] (u) to [edge label = 2/2] (w);
			%\draw[directed] (v) to [edge label =2,pos=0.4] (t);
			\draw[directed, ultra thick, cyan] (v) to [edge label = 2/2] (x);
			\draw[directed, ultra thick, cyan] (v) to [edge label = 1/3] (w);
			\draw[directed, ultra thick, cyan] (w) to [edge label = 3/3] (t);
			\draw[directed] (w) to [edge label =8] (x);
			\draw[directed, ultra thick, cyan] (x) to [edge label = 2/2] (t);
		\end{tikzpicture}\\
		Total flow at this step = 5\\
		...
		\begin{tikzpicture}[scale=1.8]
			...
			\draw[directed, ultra thick, magenta] (s) edge[bend right] node[below] {\;\;4} (u);
			%
			\draw[directed, ultra thick, cyan] (v) to [edge label = \;\;3] (s);
			%\draw[directed, ultra thick, magenta] (s) edge[bend left] node[above] {\;\;1} (v);
			\draw[directed, ultra thick, cyan] (x) to [edge label = 2] (v);
			\draw[directed, magenta] (u) to [edge label =2] (v);
			\draw[directed, ultra thick, cyan] (w) to [edge label = 2] (u);
			\draw[directed, ultra thick, cyan] (w) edge[bend right] node[below] {\;\;1} (v);
			\draw[directed, ultra thick, magenta] (v) edge[bend right] node[above] {2\;\;} (w);
			\draw[directed, ultra thick, cyan] (t) to [edge label = \;\;3] (w);
			\draw[directed, magenta] (w) to [edge label =8] (x);
			\draw[directed, ultra thick, cyan] (t) to [edge label = 2] (x);
		\end{tikzpicture}\\

		$$\fbox{Maximum flow through this graph = 5}$$
	\end{center}
	\item[(2b)] \phantom{Stuff}\\
...
\begin{center}
	\begin{tikzpicture}[scale=1.8]
		...
		\draw[directed] (w) to [edge label =8] (x);
		\draw[directed] (x) to [edge label'=2] (t);
		\draw[red, ultra thick] (4,0) -- (4,2);
	\end{tikzpicture}\\
	$S = {s,v,u,x,w}$\\
	$T = {t}$\\
	\fbox{The minimum cut value is 5}
\end{center}
\end{enumerate}
...
% STUDENTS: TYPE YOUR SOLUTIONS HERE. (Between \textbf{Solution:} and \fi )
%==============================================================================
$$\textbf{SOLUTIONS ON NEXT PAGE}$$
\newpage
\ben 
\item \phantom{test}
\begin{center}
	\textbf{PLEASE NOTE - THE COLORS HAVE NO SIGNIFICANCE, IT JUST MAKES IT MORE READABLE}\\
	\phantom{test}\\
	\begin{tikzpicture}[scale=1.8]
		...
		\node[vertex] (a) at (4,5) {$a$};
		\node[vertex] (b) at (4,4) {$b$};
		\node[vertex] (c) at (4,3) {$c$};
		\node[vertex] (d) at (4,2) {$d$};
		\node[vertex] (e) at (4,1) {$e$};
		\node[vertex] (f) at (4,0) {$f$};
		\node[vertex] (t) at (5,3) {$t$};
		
		%source to people
		\draw[directed,black] (s) to [edge label = 1]   (A);
		\draw[directed,black] (s) to [edge label = 1]   (B);
		\draw[directed,black] (s) to [edge label = 1]   (C);
		\draw[directed,black] (s) to [edge label = 1]   (D);
		\draw[directed,black] (s) to [edge label = 1]   (E);
		\draw[directed,black] (s) to [edge label = 1]   (F);

		%people to [edge label = 0/1]  games
		\draw[directed,blue] (A) to [edge label=1, pos=0.1]   (a);
		\draw[directed,blue] (A) to [edge label=1, pos=0.1]   (b);
		\draw[directed,blue] (A) to [edge label=1, pos=0.1]   (d);
		\draw[directed,black] (B) to [edge label=1, pos=0.1]   (a);
		\draw[directed,black] (B) to [edge label=1, pos=0.1]  (b);
		\draw[directed,black] (B) to [edge label=1, pos=0.1]   (d);
		\draw[directed,blue] (C) to [edge label=1, pos=0.1]   (a);
		\draw[directed,blue] (C) to [edge label=1, pos=0.1]  (c);
		\draw[directed,blue] (C) to [edge label=1, pos=0.1]   (f);
		\draw[directed,black] (D) to [edge label=1, pos=0.1]   (c);
		\draw[directed,black] (D) to [edge label=1, pos=0.1]  (e);
		\draw[directed,blue] (E) to [edge label=1, pos=0.1]   (c);
		\draw[directed,blue] (E) to [edge label=1, pos=0.1]  (e);
		\draw[directed,blue] (E) to [edge label=1, pos=0.1]   (f);
		\draw[directed,black] (F) to [edge label=1, pos=0.1]   (b);
		\draw[directed,black] (F) to [edge label=1, pos=0.1]  (e);
		\draw[directed,black] (F) to [edge label=1, pos=0.1]   (f);

		%games to [edge label = 0/1]  target
		\draw[directed,black] (a) to [edge label = 1]   (t);
		\draw[directed,black] (b) to [edge label = 1]   (t);
		\draw[directed,black] (c) to [edge label = 1]   (t);
		\draw[directed,black] (d) to [edge label = 1]   (t);
		\draw[directed,black] (e) to [edge label = 1]   (t);
		\draw[directed,black] (f) to [edge label = 1]   (t);

	\end{tikzpicture}\\
	The left (capital) letters A-F signify customers based on their inital. The right (lowercase) letters a-f signify games based on their inital.
\end{center}

\item The Ford-Fulkerson algorithm with generate the maximum flow between the nodes. We know from the graph above that if there is flow between two nodes (specifically any of the people nodes and any of the game nodes) that there has been a game sold. Since every node in the graph has flow and capcity of 1, the total flow will be the total number of games sold.
\end{enumerate}
